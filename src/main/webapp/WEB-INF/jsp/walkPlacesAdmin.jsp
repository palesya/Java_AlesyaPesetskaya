...
<div class="container p-1">
    <div class="row mx-auto">
        <nav class="navbar navbar-expand-lg primary-color rounded text-center" style="background-image: linear-gradient(to right, black, #63646A)">
            ...
            <form class="col-2 m-auto px-1" action="${pageContext.request.contextPath}/dogwalker/admin/places/city"
                  method="get">
            ...
            <form class="col-3 m-auto px-1" action="${pageContext.request.contextPath}/dogwalker/admin/places/search"
                  method="post">
